...
std::vector<float> ExerciseArbitraryTriangle::third()
{
	...
	condition = "Заданий довільний трикутник ABC. Знайти невідомі кути та сторону трикутника за стороною AB = " + to_string(AB) + "см, кутом В = " + to_string(B) + "см та кутом A = " + to_string(A) + ".\n(Відповіді давати з точніст'ю з одного знаку після коми)";
	float C=180 - B - A;
	results.push_back(C);
